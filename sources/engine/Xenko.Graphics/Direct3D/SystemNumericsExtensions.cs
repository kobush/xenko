...
namespace Xenko.Graphics
{
    public static class SystemNumericsExtensions
    {
        ...
        public static Vector3 ToXenkoVector3(this System.Numerics.Vector3 value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static Quaternion ToXenkoQuaternion(this System.Numerics.Quaternion value)
        {
        ...
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static Matrix ToXenkoMatrix(this System.Numerics.Matrix4x4 value)
        {
            return new Matrix
            {
