...
using WindowsMixedRealityDemo.Core;

namespace WindowsMixedRealityDemo.Player
{
    ...
    public class HandsInput
    {
        ...
        /// </summary>
        public Vector3[] HandMovement = new Vector3[System.Enum.GetValues(typeof(HandSide)).Length];

        /// <summary>
        /// Grabbing power of each hand, 0 being none and 1 being maximum power
        /// </summary>
        public float[] HandGrab = new float[System.Enum.GetValues(typeof(HandSide)).Length];
    }
